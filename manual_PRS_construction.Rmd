...
```{r include=FALSE}
setwd("/scratch/gen1/rn180/respiratory_fibrosis/pf_phenotypes/manual_PRS")
library(data.table)
library(pROC)
# files
base="/scratch/gen1/rn180/respiratory_fibrosis/prs/reportedb37b.assoc"
base="/scratch/gen1/rn180/respiratory_fibrosis/prs/reportedb37b.assoc"
target="hypersensitivityPF_all_swapped.raw"
pheno_file="../matching_controls/hypersensitivityPF_all_cases_controls.pheno"
cov_file="../matching_controls/hypersensitivityPF_all_cases_controls.cov"
# read
base <- fread(base)
